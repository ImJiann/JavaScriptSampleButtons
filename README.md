...
<head>
    ...
    <style>
        ...
        .sample { border: 1px solid #ccc; padding: 15px; margin-bottom: 20px; border-radius: 8px; background: #fae8e8; }
...
<body>
    <h1><i>JavaScript Button Samples</i></h1>
    <hr>
    <!-- SAMPLE 1: Basic Alert Button -->
    <div class="sample">
        <h2>Sample 1: <i>Alert Button (Inline JavaScript)</i></h2>
    ...
    <div class="sample">
        <h2>Sample 2: <i>Function Button</i></h2>
    ...
    <div class="sample">
        <h2>Sample 3: <i>Change Text Button</i></h2>
    ...
    <!-- SAMPLE 4: Counter -->
    <div class="sample">
        <h2>Sample 4: <i>Counter Button (let and increment)</i></h2>
    ...
    <div class="sample">
        <h2>Sample 5: <i>Input Field</i></h2>
    ...
    <div class="sample">
        <h2>Sample 6: <i>If Statement Button</i></h2>
    ...
    <div class="sample">
        <h2>Sample 7: <i>Multiple Parameters</i> (Add Numbers)</h2>
    ...
    <div class="sample">
        <h2>Sample 8: <i>Toggle Button (Boolean)</i></h2>
